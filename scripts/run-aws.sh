...
echo "Run 1"
${tcmalloc} ${mainDir}/main 1 1 | tee log_ycsb_1

echo "Run 2"
${tcmalloc} ${mainDir}/main 1 1 | tee log_ycsb_2
...
#
rm -f /scratch0/kvell/* # Change in # workers, reset DB
...
echo "Run 1 (scans)"
${tcmalloc} ${mainDir}/main 1 1 | tee log_ycsb_e_1

echo "Run 2 (scans)"
${tcmalloc} ${mainDir}/main 1 1 | tee log_ycsb_e_2
